...
from models.mnist.Regressor import Regressor
from models.mnist.utils_local import *;
...
class Model(nn.Module):
    def __init__(self, input_dim, embed_dim, z_dim,  normal_layers, stoch_layers, data=None):
