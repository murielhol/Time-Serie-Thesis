...
class Model(nn.Module):
    def __init__(self, input_dim, embed_dim, loss, layers, batch_norm=False, data=None, final_out_dim=1):
        ...
        #self.loss = 'Gaussian';
        self.loss = loss;
        self.regressor = Regressor(self.loss, embed_dim, final_out_dim);
