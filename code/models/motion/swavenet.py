...
from models.finance.Regressor import Regressor
from models.finance.utils_local import *;
...
class Model(nn.Module):
    def __init__(self, input_dim, embed_dim, z_dim, loss, layers, stoch_layers, data=None):
