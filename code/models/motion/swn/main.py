...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str, default='swn_motion_5-1a', help='Unique name of the model')
    ...
    parser.add_argument('--num_stochastic_layers', type=int, default=2, help='Number of layers in the model')
    ...
    parser.add_argument('--seed', type=int, default=1, help='Integer random seed')
