...
def main(config):
    ...
    if config.validate:
        model._backtest(epoch=140)
        # model._validate(steps = config.output_seq_length, epoch=140)
    else:
        model._train()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str, default='test_mv', help='Unique name of the model')
