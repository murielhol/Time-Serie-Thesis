...
if __name__ == "__main__":
    ...
    parser.add_argument('--filter_size', type=int, default=2, help='Size of the filters')
    ...
    parser.add_argument('--backtest', default=False, help='If only want to validate the stored model')
