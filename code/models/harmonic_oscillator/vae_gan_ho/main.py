...
def main(config):
    ...
    if config.validate:
        model._validate(steps = config.output_seq_length, epoch=180)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str, default='vaegan_ho_team', help='Unique name of the model')

    # Model params
    parser.add_argument('--input_seq_length', type=int, default=64, help='Length of an input sequence')
    parser.add_argument('--output_seq_length', type=int, default=20, help='Length of the output sequence')
