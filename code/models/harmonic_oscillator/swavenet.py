...
from models.harmonic_oscillator.Regressor import Regressor
from models.harmonic_oscillator.utils_local import *;
...
class Model(nn.Module):
    def __init__(self, input_dim, embed_dim, z_dim, loss, normal_layers, stoch_layers, data=None):
        ...
        self.mlp_dim = z_dim;
        mlp_dim = z_dim;
        self.num_layer = stoch_layers;
        self.pre_layer = normal_layers;
